...
(function ($) {
    ...
    $("#m_timer").countdowntimer({
     ...
     //var gri = document.getElementById("grid").disabled = true;
     //var gri = document.getElementByTagName("div").disabled = true;
     var btn = document.createElement("div");
        btn.className = "botonFin";

        //var t = document.createTextNode("You Won in " + moves + " moves!");
        //t.className = "textoFinal";
        //btn.appendChild(t);
